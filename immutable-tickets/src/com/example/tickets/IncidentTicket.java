...
/**
 * Immutable incident ticket created exclusively via its Builder.
 *
 * - All fields are private final
 * - No setters
 * - Tags list is defensively copied on construction and returned as
 * unmodifiable
 * - All validation is centralized in Builder.build()
 * - Use toBuilder() to create a modified copy
 */
public final class IncidentTicket {
    ...
    public static class Builder {
        ...
        /**
         * Validates and builds an immutable IncidentTicket.
